...
for (let i = 0; i < coursesAndDurationArray2.length; i++) {
    ...
    let monthDuration = coursesAndDurationArray2[i].monthDuration;
    let headingElement = document.createElement('h1');
    headingElement.classList.add('heading');
    headingElement.textContent = title;
    let descriptionElement = document.createElement('p');
    descriptionElement.classList.add('description');
    descriptionElement.textContent = `Duration: ${monthDuration} months`;
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    simpsons.forEach(member => {
        ...
        infoParagraph.textContent = `${member.name} ${member.surname}, Age: ${member.age}\n${member.info}`;
